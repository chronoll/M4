...
const statusIcons: Record<Todo["status"], { icon: React.ReactNode; color: string }> = {
...
//image[aoi-edit-status][セレクトボックスの様子]
...
//list[celleditor-custom-usage][カスタムエディタの使用]{
{
  field: "status",
  headerName: "ステータス",
  editable: true,
